---
title: "Hello, Quarto!"
subtitle: "pyOpenSci Fall Festival 2024: Reproducible reports and presentations <br> with Quarto and Great Tables"
author: "Tracy Teal and Rich Iannone"
institute: "Slides forked from Mine Çetinkaya Rundel"
footer: "🔗 [https://bit.ly/quarto-GT-pyopensci](https://bit.ly/quarto-GT-pyopensci)"
format:
  revealjs:
...
![](images/rich.png){fig-alt="Rich's headshot" fig-align="center" width=2in}
![](images/tracy2.png){fig-alt="Tracy's headshot" fig-align="center" width=2in}
...
::: your-turn
Go to the [setup instructions](https://tracykteal.github.io/quarto-GT-pyopensci/setup.html)
:::
